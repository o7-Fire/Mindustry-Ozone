...
public class SettingsDialogOzone extends SettingsMenuDialog {
    ...
    void rebuildMenu(){
        ...
        menu.row();
        menu.button("@settings.ozone", style, () -> visible(2));
        menu.row();
    ...
    void addSettings(){
        ...
        if(mobile){
            ...
            game.checkPref("keyboard", false, val -> control.setInput(val ? new mindustry.input.DesktopInput() : new MobileInput()));
    ...
    private void visible(int index){
        prefs.clearChildren();
        prefs.add(new Table[]{game, graphics, sound, ozone}[index]);
    }
